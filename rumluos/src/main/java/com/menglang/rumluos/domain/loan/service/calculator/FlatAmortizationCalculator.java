...
/**
 * Flat interest rate amortization calculator.
 * Principal due is divided equally; interest is calculated once on the initial principal.
 */
@Component("FLAT_CALCULATOR")
public class FlatAmortizationCalculator implements AmortizationCalculator {
    ...
    public List<LoanSchedule> generateSchedules(Loan loan) {
        ...
        BigDecimal interestDue = principal.multiply(periodicRate).setScale(4, RoundingMode.HALF_UP);
